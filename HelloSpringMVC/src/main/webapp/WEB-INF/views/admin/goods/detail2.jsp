	...
	<div style="position: relative; left: 10px; top: -20px; z-index: 1;">
		<section class="products" id="products">
			<div class="box-container">
				...
				<div class="1" items="${data}" style="float: left">
					<h1>상품정보</h1>
				...
				<div id="option">
					...
					<div>상품번호: ${data.pd_num}</div>
					<div>상품명: ${data.pd_name}</div>
					<div>상품 가격: ${data.price}</div>
					<div>수량: 
					...
					<form>
					  <button type="submit" formaction="/home" style="border: 2px solid;" >카트에 담기</button>
					 &nbsp;
					  <button type="submit" formaction="/home" style="border: 2px solid;" >구매하기</button>
